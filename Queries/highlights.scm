...
; Class
(class_name_statement (name) @definition.class)
(class_definition (name) @definition.class)
; Enumeration
(enum_definition (name) @definition.enum)
(enumerator
  left: (constant) @identifier.constant)
; Method
(function_definition
...
(signal_statement
  ...
  parameters: (parameters) @identifier.argument)
; Variable
(variable_statement (name) @definition.variable)
(export_variable_statement (name) @definition.variable)
; Constant
(const_statement (name) @definition.constant)
; Function definitions
(constructor_definition "_init" @definition.method)
(lambda (parameters) @definition.function)
...
; Enum
(enumerator (identifier) @identifier.key)
(enumeration_call
  name: (constant) @identifier.enumeration
  value: (constant) @identifier.constant)
; Method
(attribute_call (identifier) @identifier.method)
(base_call (identifier) @identifier.method)
(call (identifier) @identifier.method)
(lambda (name) @identifier.method)
; Self
(self_call
  (self) @keyword.self
